...
class Book {
    ...
    public Book() {
        ...
        try (Scanner bookDetails = new Scanner(System.in)) {
...
public class Librarymanagement {
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            System.out.println("[_____Welcome ITUM Library_____]" );

            // Initial books in the library
            Book fictionBook1 = new Book("Once upon a time", "Sidath Maarapana", 78462);
            Book fictionBook2 = new Book("The Space", "Rahal viduranga", 52368);
            Book fictionBook3 = new Book("The 100", "Sithara Madanayake", 45962);
            
            // Nonfiction books
            Book nonFictionBook1 = new Book("Walking Zombie", "Anchlora denis", 78634);
            Book nonFictionBook2 = new Book("Tamil Culture", "U.Karunaadan", 46258);
            Book nonFictionBook3 = new Book("Kidurangana", "Harindra Samarakoon", 78302);

            // Adding books to the library
            library.addBook(fictionBook1, true);
            library.addBook(fictionBook2, true);
            library.addBook(fictionBook3, true);
            library.addBook(nonFictionBook1, false);
            library.addBook(nonFictionBook2, false);
            library.addBook(nonFictionBook3, false);
